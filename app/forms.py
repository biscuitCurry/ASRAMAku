...
from .models import OutingRequest, Student
...
class StudentForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "course": forms.TextInput(
                attrs={"class": "form-control text-uppercase", "placeholder": "Course"}
            ),
            "session": forms.TextInput(
                attrs={
                    "id": "session-input",
                    "class": "form-control",
                    "placeholder": "Session (e.g., JUL-DIS 2024)",
                }
            ),
            "student_id": forms.TextInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "Matric ID (e.g., 1234567890)",
                }
            ),
            "id_card": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "IC Number"}
            ),
            "rfid_uid": forms.TextInput(
                attrs={
                    "id": "rfid-input",
                    "class": "form-control",
                    "placeholder": "RFID UID (Tap your IC on RFID scanner)",
                }
            ),  # Added explicit ID
            ...
            "tvetmara_email": forms.EmailInput(
                attrs={
                    "class": "form-control",
                    "placeholder": "TVETMARA Email (e.g., student@sgpetani.tvetmara.edu.my)",
                }
            ),
    ...
    def clean_course(self):
        return self.cleaned_data["course"].upper()
...
class OutingRequestForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "outing_date": forms.DateInput(
                attrs={"class": "form-control", "type": "date"}
            ),
            "outing_time": forms.TimeInput(
